...
This is an Android app (Gradle Kotlin DSL, AGP 9.2.1, Kotlin 2.4.0, JDK 21,
`compileSdk`/`targetSdk` 37, `minSdk` 26, Gradle wrapper 9.6.1). Standard
build/run commands are in `README.md` and `.github/workflows/ci.yml`.
